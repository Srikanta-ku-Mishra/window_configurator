import { Box2, BufferGeometry, Camera, ColorSpace, DataTexture, Object3D, Texture, Vector4, WebGLRenderer, WebGLRenderTarget } from 'three';
 ...
 */
export declare function toIndexedGeometry(geometry: BufferGeometry, tolerance?: number): BufferGeometry<import("three").NormalBufferAttributes, Event, string>;
