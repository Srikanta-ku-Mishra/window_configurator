...
export declare abstract class MaterialLibraryBasePlugin extends AViewerPlugin<''> {
    ...
    protected _selectedObject: () => (IModel<any> & Mesh<BufferGeometry<import("three").NormalBufferAttributes, Event, string>, Material<import("three").Event, string>>) | undefined;
